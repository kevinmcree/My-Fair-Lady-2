	...
	void Update () {
		...
		if (extended==true){
			...
			//	this.GetComponent<CapsuleCollider>().height=4;
				transform.position = new Vector3(player.transform.position.x-1.2f, player.transform.position.y-.1f, player.transform.position.z+3.3f);
			...
			if (player.GetComponent<Done_PlayerController>().powerUp==1){
				transform.position = new Vector3(player.transform.position.x-1.2f, player.transform.position.y-.1f, player.transform.position.z+5.7f);
			...
			if (player.GetComponent<Done_PlayerController>().powerUp==2){
				transform.position = new Vector3(player.transform.position.x-1.2f, player.transform.position.y-.1f, player.transform.position.z+7.5f);
			...
			if (player.GetComponent<Done_PlayerController>().powerUp==3){
				transform.position = new Vector3(player.transform.position.x-1.2f, player.transform.position.y-.1f, player.transform.position.z+9.8f);
			...
			if (player.GetComponent<Done_PlayerController>().powerUp==4){
				transform.position = new Vector3(player.transform.position.x-1.2f, player.transform.position.y-.1f, player.transform.position.z+9.8f);
				transform.localScale = new Vector3(40,1,38);
				this.GetComponent<CapsuleCollider>().height=22;
				this.GetComponent<CapsuleCollider>().radius=.025f;
